       ...
       <div className="container mx-auto">
            <div className="navbar bg-base-100 mt-3">
                ...
                <div className="navbar-end">
                        ...
                        <input className="bg-[#150B2B0D] rounded-l-2xl px-4 py-2 border-none" type="text" name="" id="" placeholder="Search Here...."/>
                        <button className=" mr-3 px-3 py-2 bg-[#0BE58A] rounded-r-2xl border-none text-white">Search</button>
            ...
            <div className="h-[500px] mt-3 relative rounded-2xl">
                <img className="bg-cover bg-no-repeat h-full w-full rounded-2xl" src={coverImage} alt="" />
                <div className="absolute inset-0 bg-black opacity-40 rounded-2xl"></div>

                <div className="absolute top-[75px] left-[200px] right-[200px]  text-white text-center">
